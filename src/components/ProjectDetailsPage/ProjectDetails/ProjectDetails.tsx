            ...
            <div className="flex items-center gap-6">
              {tabButtons.map((item, index) => (
                <button
                  ...
                  className={`relative z-20 px-5 sm:px-6 py-2 transition duration-300 border rounded-full cursor-pointer font-medium text-center text-nowrap hover:text-white ${
                    activeTab === item
