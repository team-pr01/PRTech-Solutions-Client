...
const TestimonialCard: React.FC<TestimonialCardProps> = ({
  ...
  return (
    <div className="bg-gray-200 font-Inter rounded-2xl p-6 md:p-10 shadow-xl flex flex-col md:flex-row items-center justify-between gap-8 border border-primary-70 relative">
