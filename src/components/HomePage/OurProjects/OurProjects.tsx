      ...
      <Container>
        <div className="relative py-10 md:py-14 xl:py-20 z-10">
          ...
          <motion.p
            ...
            className="text-neutral-30 font-Inter text-sm xl:text-base leading-6 max-w-[900px] mx-auto text-center mt-7"
          >
          ...
          <div>
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 mt-16 max-w-[1100px] mx-auto">
