...
const HeroSubtitle = () => {
  return (
    <div className="relative mx-auto w-full sm:w-fit rounded-full bg-gradient-to-r from-white via-whites-20 to-whites-05 p-0.5 shadow-3xl">
      <div className=" bg-primary-60 w-full sm:w-fit rounded-full gap-4">
