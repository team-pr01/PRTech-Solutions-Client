          ...
          <Container>
            <div className="text-center px-4">
              <motion.h1
                ...
                className="text-center font-Inter text-[28px] md:text-5xl lg:text-6xl 2xl:text-[70px] text-white font-bold leading-10 md:leading-[60px] lg:leading-[90px] text-balance"
              >
              ...
              <motion.p
                ...
                className="text-white/80 text-center font-Inter text-xs md:text-base font-normal leading-4 md:leading-5 lg:leading-8 2xl:leading-[30px] max-w-[543px] lg:max-w-[720px] mx-auto mt-6"
              >
