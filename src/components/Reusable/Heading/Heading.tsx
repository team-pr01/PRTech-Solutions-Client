...
const Heading: React.FC<HeadingProps> = ({
  ...
  return (
    <div className={`${alignment} flex flex-col gap-7 lg:gap-5 2xl:gap-6 ${className}`}>
      ...
      {subHeading && (
        <p className={`text-neutral-30 font-Inter text-sm md:text-base leading-4 md:leading-7 max-w-full lg:max-w-[800px] text-center ${align === "left" ? "mx-0" : "mx-auto"} ${alignment} ${subHeadingClassName}`}>
          {subHeading}
        </p>
      )}
    </div>
